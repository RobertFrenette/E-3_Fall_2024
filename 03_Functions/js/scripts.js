...
window.onload = function () {
  ...
  function buildContactHTML() {
    ...
    const contactHTML = `
                  <div class='col-md-4'>
                    <div class='card'>
                      <img src='${contactImgSrcPath}' class='card-img-top' alt='${fieldValues.contactFName} ${fieldValues.contactLName}' />
                      <div class='card-body'>
                        <h4 class='card-title'>${fieldValues.contactFName} ${fieldValues.contactLName}</h4>
                        email: <a href='mailto:${fieldValues.contactEmail}'>${fieldValues.contactEmail}</a>
                        <br>phone: ${fieldValues.contactPhoneAreaCode} - ${fieldValues.contactPhonePrefix} - ${fieldValues.contactPhoneNumber}
                        <br>birthday: ${fieldValues.contactBirthdayMonth} / ${fieldValues.contactBirthdayDay}
                      </div>
                    </div>
                  </div>`;
  ...
  addContactForm.addEventListener("submit", (evt) => {
    ...
    if (errorMsgs.length === 0) {
      ...
      contacts.push(buildContactHTML());
      displayContacts();
